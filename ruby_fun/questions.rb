...
def average_of_array(array)
  array.inject { |sum, var| sum + var } / array.length.to_i + 1
end
...
def add_together_keys_and_values(hash)
  new_array = hash.flatten
  new_array.inject { |total, num| total + num}
end
